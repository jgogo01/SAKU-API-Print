...
<div style="text-align:start;">
    ...
    <br>
    <span>
        <input type="checkbox" <?= $rowPj['kasetsartStudentIdentity'] == "INTEGRITY" ? "checked=\"checked\"" : "" ?> /> สำนึกดี (Integrity)
        &nbsp;
        <input type="checkbox" <?= $rowPj['kasetsartStudentIdentity'] == "DETERMINATION" ? "checked=\"checked\"" : "" ?> /> มุ่งมั่น (Determination)
        &nbsp;
        <input type="checkbox" <?= $rowPj['kasetsartStudentIdentity'] == "KNOWLEDGE_CREATION" ? "checked=\"checked\"" : "" ?> /> สร้างสรรค์ (Knowledge Creation)
        &nbsp;
        <input type="checkbox" <?= $rowPj['kasetsartStudentIdentity'] == "UNITY" ? "checked=\"checked\"" : "" ?> /> สามัคคี (Unity)
    </span>
</div>
